 ...
 */
final class Version20211028133929 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, client_id INT NOT NULL, name VARCHAR(32) NOT NULL, balance INT NOT NULL, PRIMARY KEY(id))');
